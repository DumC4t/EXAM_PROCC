...
/* ------------------ getAllQuestionsAndAnswers: UPDATED with Global Timer (E2) ------------------ */
function getAllQuestionsAndAnswers(sheetCode) {
  try {
    ...
    // UPDATED: Read columns A-E (5 columns) to include the Global Timer in E
    ...
    const response = {
      ...
      globalExamTimerSeconds: globalExamTimerSeconds // NEW: Sent to the system
    };
